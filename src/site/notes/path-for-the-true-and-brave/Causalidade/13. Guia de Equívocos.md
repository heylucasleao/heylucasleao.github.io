...
# Checklist para Projetos de Inferência

Para garantir o rigor das suas análises, siga sempre este fluxo:
1. **Possibilidade de Randomização:** Avalie se o problema permite um experimento controlado. Se não, identifique as fontes de confusão.
2. **Desenho do DAG:** Construa o grafo causal baseado no conhecimento de negócio. Identifique mediadores, confounders e colisores.
3. **Validação de Premissas:** Verifique as premissas fundamentais (SUTVA, Positividade e Ignorabilidade). Caso sejam atendidas, siga para avaliação em métodos observacionais. Caso contrário, isto é, alguma premissa não seja atendida, pense em métodos Quasi-Experimentais.
4. 
[Infográfico](assets/infografico_causal.html)

<iframe src="assets/infografico_causal.html" style="width:100%; height:500px; border:none;"></iframe>
