---
{"dg-publish":true,"permalink":"/path-for-the-true-and-brave/causalidade/12-double-machine-learning/"}
---

![dml_1.png](/img/user/path-for-the-true-and-brave/assets/dml_1.png)
...
2. **Estimar o tratamento $T$:** Usamos outro modelo de ML flexível ($g(X)$) para prever o tratamento $T$ com base nas características $X$ (similar a um Propensity Score).

3. **Obtemos os resíduos:**
    
    - Resíduo do outcome: $\tilde{Y} = Y - \hat{q}(X)$
        
    - Resíduo do tratamento: $\tilde{T} = T - \hat{g}(X)$
...
![cross_fitting.png](/img/user/path-for-the-true-and-brave/assets/cross_fitting.png)
...
![dml_2.png](/img/user/path-for-the-true-and-brave/assets/dml_2.png)
