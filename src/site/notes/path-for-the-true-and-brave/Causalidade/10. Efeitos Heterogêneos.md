---
{"dg-publish":true,"permalink":"/path-for-the-true-and-brave/causalidade/10-efeitos-heterogeneos/"}
---
...
- $\hat{y}(t + 1)$ é a predição do modelo incrementando o tratamento original em uma unidade.
- $\hat{y}(t)$ é a predição do modelo com os dados originais.
