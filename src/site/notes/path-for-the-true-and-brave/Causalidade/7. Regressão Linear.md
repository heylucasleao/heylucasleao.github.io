---
{"dg-publish":true,"permalink":"/path-for-the-true-and-brave/causalidade/7-regressao-linear/"}
---
...
Se o seu modelo é $Y = \beta_0 + \beta_1 T + \beta_2 X + \epsilon$, a estimativa de $\hat{\beta}_1$ é o $ATE$.
...
> Isto significa que usamos o grupo de controle $T=0$ para construir o modelo que prevê o resultado potencial $Y_0$.
