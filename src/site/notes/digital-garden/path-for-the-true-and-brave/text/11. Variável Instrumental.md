...
- A impossibilidade de garantir que todos os indivíduos designados ao grupo de tratamento efetivamente recebam ou utilizem o tratamento. Isso caracteriza uma violação do perfect compliance.
...
>[!Abstract] Assista
>[Como lidar com endogeniedade? | Entenda as Variáveis Instrumentais ](https://www.youtube.com/watch?v=pvHoHlPQI3A)
>
...
>[Some ways to measure effects with imperfect compliance](https://www.everydaycausal.com/instrumental-variables.html#some-ways-to-measure-effects-with-imperfect-compliance)
...
>[!abstract] Leitura Recomendada
>[Two-stage least squares: from the Wald estimator to regression](https://www.everydaycausal.com/instrumental-variables.html#two-stage-least-squares-from-the-wald-estimator-to-regression)
