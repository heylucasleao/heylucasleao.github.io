...
O modelos de regressão linear é uma ferramenta tradicional para estimar o impacto de tratamento. Utilizando o método dos Mínimos Quadrados Ordinários (MQO), é possível estimar parâmetros que, sob as suposições corretas de identificação, possuem uma interpretação causal direta.
