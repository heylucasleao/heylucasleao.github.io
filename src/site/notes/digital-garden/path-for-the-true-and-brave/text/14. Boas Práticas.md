...
Para facilitar a identificação da abordagem adequada, deixei um [infográfico dinâmico](https://heylucasleao.github.io/html-files/infografico_causal.html) para **me** ajudar, mas utilize com ressalvas, acredito em suma ser limitado. Se você utiliza ferramentas de GenAI, há o [PyWhyLLM](https://github.com/py-why/pywhyllm) como assistente para exploração, ou o [Causal LLM Agent](https://cais-web.vercel.app/) citados anteriormente em [[digital-garden/path-for-the-true-and-brave/text/13. GenAI e Causal Reasoning\|13. GenAI e Causal Reasoning]].
# Equívocos
