...
>[!tip]
>Como comentado anteriormente, podemos utilizar o [PyWhyLLM](https://github.com/py-why/pywhyllm) como um assistente para exploração, como também o [Causal LLM Agent](https://cais-web.vercel.app/) do [laboratório Jinesis, da universidade de Toronto](https://zhijing-jin.com/).
# Equívocos
