...
Resultados e hipóteses exigem seriedade. As hipóteses devem ser formuladas **antes** do estudo, e não ajustadas _a posteriori_ para se adequarem aos dados observados. Modelar resultados baseando-se em hipóteses criadas após a análise é uma prática problemática, pois aumenta o risco de detectar padrões espúrios (acaso), induzindo a tomadas de decisão equivocadas.

Portanto, um escopo de boas práticas deve ser bem definido, focando na leitura crítica dos resultados de um experimento, seja ele observacional ou randomizado. O objetivo central é responder a perguntas de causa e efeito que impactam diretamente a unidade de estudo.

![boas_praticas.png](/img/user/digital-garden/path-for-the-true-and-brave/assets/boas_praticas.png)
[Causal machine learning for predicting treatment outcomes](https://arxiv.org/abs/2410.08770)

Existem boas referências sobre boas práticas, como o artigo citado acima e o [A Causal Roadmap for Generating High-Quality Real-World Evidence](https://arxiv.org/abs/2305.06850).

Para facilitar a identificação da abordagem mais adequada ao seu problema, deixei um [infográfico dinâmico](https://heylucasleao.github.io/html-files/infografico_causal.html) para me ajudar, mas sei que ele é de certa forma limitado. Se você utiliza ferramentas de GenAI, também há o [PyWhyLLM](https://github.com/py-why/pywhyllm) como assistente para exploração, ou o [Causal LLM Agent](https://cais-web.vercel.app/).
# Equívocos
