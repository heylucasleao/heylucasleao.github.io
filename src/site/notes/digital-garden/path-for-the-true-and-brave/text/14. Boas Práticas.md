...
É importante pontuar que no artigo, esclarece a importância do pesquisador em utilizar frameworks, como [_Target Trial Emulation (TTE)_](https://www.psychiatrist.com/pdf/target-trial-emulation-a-concept-simply-explained-pdf/), que força a serem especificos, em quatro componentes:
1. Quem é o público alvo na população?
2. Qual a definição de estratégia para o tratamento?
3. Quanto tempo durará o experimento?
4. Qual a definição clara de outcome?

Para facilitar a identificação da abordagem adequada, deixei um [infográfico dinâmico](https://heylucasleao.github.io/html-files/infografico_causal.html) para me ajudar para mim, mas utilize com ressalvas, acredito em suma ser limitado. Se você utiliza ferramentas de GenAI, há o [PyWhyLLM](https://github.com/py-why/pywhyllm) como assistente para exploração, ou o [Causal LLM Agent](https://cais-web.vercel.app/).
# Equívocos
