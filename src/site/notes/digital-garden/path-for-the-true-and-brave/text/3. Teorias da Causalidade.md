...
- Outcomes e potenciais outcomes
    ...
    - Outcome observado: $$Y_i = Y_i(D_i) = D_i\cdot Y_i(1) + (1 - D_i)\cdot Y_i(0).$$
- Estimandos Comuns
    
    - Efeito Médio de Tratamento (ATE): $$\text{ATE} = \mathbb{E}[Y_i(1) - Y_i(0)].$$
    - Efeito Médio no Tratado (ATT / ATET): $$\text{ATT} = \mathbb{E}[Y_i(1) - Y_i(0) \mid D_i = 1].$$
