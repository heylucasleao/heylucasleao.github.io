---
{"dg-publish":true,"permalink":"/digital-garden/receitas/text/agua/","dg-note-properties":{}}
---
...
A química da água para café divide-se em dois pilares principais:

- **Alcalinidade (Ânions Tampão):** Capacidade da água de neutralizar ácidos e regular a percepção de pH na xícara.
...
Podemos dividir os sais de carga nativa entre dois grupos:
#### Cátions
...
| **Cálcio**<br><br>  <br><br>($\text{Ca}^{2+}$)                       | **Brilho:** ~2.8 / 5<br><br>  <br><br>**Corpo:** ~4.2 / 5 | Arredonda o sabor geral e traz riqueza tátil. Realça a doçura de frutas vermelhas (morango, cereja) e adiciona corpo e densidade.          | • Realçador de Doçura<br><br>• Realçador de Corpo<br><br>• Realçador de Intensidade                                        | Proporciona sensação de preenchimento na boca e sustenta uma doçura rica e encorpada.                         |
| **Sódio**<br><br>  <br><br>($\text{Na}^{+}$)                         | **Brilho:** ~3.8 / 5<br><br>  <br><br>**Corpo:** ~0.8 / 5 | Atua como "sal na cozinha": suaviza o amargor agressivo, lapida a acidez mantendo-a limpa e amplifica a doçura natural do grão.            | • Realçador de Doçura<br><br>• Realçador de Acidez<br><br>• Inibidor de Amargor<br><br>• Realçador de Intensidade          | Limpa imperfeições, suaviza adstringências e traz os sabores à tona de forma limpa e destacada.               |
| **Potássio**<br><br>  <br><br>($\text{K}^{+}$)                       | **Brilho:** ~3.0 / 5<br><br>  <br><br>**Corpo:** ~3.3 / 5 | Aprofunda e prolonga os sabores no retrogosto. Estende a percepção de doçura e riqueza do corpo conforme o café finaliza no paladar.       | • Realçador de Doçura<br><br>• Realçador de Corpo<br><br>• Realçador de Amargor<br><br>• Realçador de Retrogosto           | Dá sustentação e profundidade à bebida, garantindo um final longo, luxuoso e persistentemente macio.          |
| **Cloreto**<br><br>  <br><br>($\text{Cl}^{-}$)                       | **Brilho:** ~1.8 / 5<br><br>  <br><br>**Corpo:** ~3.8 / 5 | Suaviza arestas e asperezas. Arredonda a acidez e o amargor, conferindo toque aveludado e equilíbrio à doçura.                             | • Realçador de Doçura<br><br>  <br><br>• Realçador de Corpo<br><br>• Inibidor de Amargor<br><br>• Realçador de Intensidade | Proporciona equilíbrio harmonioso, textura macia e acabamento aveludado, reduzindo notas ásperas.             |
| **Citrato**<br><br>  <br><br>($\text{C}_6\text{H}_5\text{O}_7^{3-}$) | **Brilho:** ~4.2 / 5<br><br>  <br><br>**Corpo:** ~3.8 / 5 | Afia a acidez trazendo brilho cítrico nítido. Em excesso, pode ser dosado para atenuar acidez frutada muito agressiva.                     | • Realçador de Acidez<br><br>• Realçador de Intensidade<br><br>• Inibidor de Acidez                                        | Concede acidez limpa, efervescente e vibrante; serve também para equilibrar cafés com acidez cortante.        |
| **Sulfato**<br><br>  <br><br>($\text{SO}_4^{2-}$)                    | **Brilho:** ~3.2 / 5<br><br>  <br><br>**Corpo:** ~4.8 / 5 | Intensifica notas florais e cítricas, além de adicionar um amargor sutil e medido que estende o perfil aromático e aumenta a complexidade. | • Realçador de Corpo<br><br>• Realçador de Amargor<br><br>• Realçador de Retrogosto                                        | Confere densidade ao corpo e um final de boca complexo, marcante e duradouro.                                 |
| **Fosfato**<br><br>  <br><br>($\text{PO}_4^{3-}$)                    | **Brilho:** ~1.8 / 5<br><br>  <br><br>**Corpo:** ~2.7 / 5 | Mantém a clareza e o equilíbrio da acidez. Evita que o corpo ou o amargor se tornem pesados, adstringentes ou opacos.                      | • Realçador de Corpo<br><br>• Realçador de Amargor<br><br>• Realçador de Retrogosto<br><br>• Inibidor de Acidez            | Traz definição e "respiro" à xícara, garantindo um retrogosto limpo, sem perda de brilho.                     |
| **Bicarbonato**<br><br>  <br><br>($\text{HCO}_3^{-}$)                | **Brilho:** ~0.3 / 5<br><br>  <br><br>**Corpo:** ~4.3 / 5 | Funciona como tampão, neutralizando o excesso de acidez e reduzindo o amargor cortante para criar uma bebida mais macia e arredondada.     | • Inibidor de Amargor<br><br>• Inibidor de Acidez                                                                          | Suaviza notas ácidas/amargas pontiagudas, resultando em uma xícara equilibrada, aveludada e de baixa acidez.  |
# Receitas
...
Antes de mais nada, é importante falar que utilizo uma abordagem de tamponamento baixo (KH < 25 ppm) a baixíssimo (KH < 15 ppm), mantendo o GH e o TDS resultante proporcionalmente reduzidos. Esse controle mínimo de alcalinidade permite que as notas mais leves e voláteis, como florais e cítricos, fiquem muito mais evidentes e vivas no paladar e no retronasal. Em contrapartida, há uma perda natural de corpo e textura. Bem, não existe almoço grátis. Ainda assim, demonstro em outros dois perfis como consigo obter textura aveludada ou um corpo suculento — para frutados — utilizando essa mesma abordagem, mas mudando proporção de bicarbonato e sulfato de magnésio.  
  
Para filtrados, esse é o meu estilo de xícara. Tenho menos notas pesadas, mas a extração de notas leves e a clareza sensorial ficam no limite.  
  
Não indico este perfil para espressos, para métodos que transportem microfines em excesso, ou para grãos com defeitos relevantes. Por proporcionar extrema nitidez, qualquer imperfeição — como quakers ou notas de fumaça — fica evidente demais. Selecionar uma boa torra e catar quakers e grãos imaturos antes de moer é essencial.

- **GH 30 ppm / KH 13,5 ppm:** Mineralização baixíssima focada em extração limpa. Ideal para grãos delicados, complexos e florais. Ponto focal em maximizar o brilho cítrico e a transparência aromática sem interferência de corpo.
