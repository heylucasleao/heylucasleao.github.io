...
7. **Altura:** Importante também notar a altura do melodrip. Muitos gostam de fazer bem próximo do café, eu inclusivo. Isso vai perturbar pouco o leito de café, diminuindo a extração indesejada de insolúveis, enaltecendo clareza de notas. 
	
8. **Descanso:** Assim que a extração finalizar, já insira a esfera e comece a aerar. É crucial fazer isso o quanto antes para preservar o máximo dos compostos aromáticos na xícara. A temperatura vai cair entre 75°C a 65°C, o que ajuda para as primeiras percepções sensoriais, seguindo o [Specialty Coffee Association - Protocols and Best Practices](https://www.scith.coffee/wp-content/uploads/2021/03/SCA-Protocols-_-Best-Practices.pdf). Caso esteja no inverno e a temperatura ambiente estiver abaixo dos 20°C, não recomendo. A xícara sozinha já irá roubar calor suficiente.
...
O importante é provar e ajustar conforme a necessidade. Trinta segundos para pré-infusões mais curtas, dois minutos mais longas caso necessário. Raramente eu preciso algo mais que um minuto.
